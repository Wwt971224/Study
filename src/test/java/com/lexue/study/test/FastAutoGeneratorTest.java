...
//        datasource.setUrl("jdbc:mysql://39.97.233.123:3306/wwt?autoReconnect=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&serverTimezone=Asia/Shanghai");
...
//        packageConfig.setParent("com.lexue.study.spring");
//        packageConfig.setEntity(MODULE_NAME + "dao.entity");
//        packageConfig.setMapper(MODULE_NAME + "dao.repository");
...
////        strategy.setSuperEntityClass("com.lexue.user.action.common.entity.BaseEntity");
